 ...
 *
 * If you have any questions related to code, you can drop them in my Twitter DM @Sgndesigner
 * or in my email at contact2cyberhunt@gmail.com
 *
...
fetch(
  'https://api.github.com/repos/Sgndesigner/text-to-handwriting/contributors'
)
  .then((res) => res.json())
  .then((res) => {
